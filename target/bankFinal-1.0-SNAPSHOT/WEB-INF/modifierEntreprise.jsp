...
<main>
    <div class="container">
        ...
        <form method="post" action="modifier_entreprise">
            <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control" id="name" name="nom" placeholder="entrer a name" value="<%=entreprise.getNom()%>">
            </div>
            <div class="mb-3">
                <label for="solde" class="form-label">Solde</label>
                <input type="number" class="form-control" id="solde"  name="solde" placeholder="entrer a solde" value="<%=entreprise.getSolde()%>">
